...
- **Deleting a folder deletes the marker only.** Removing `logs/` deletes the empty marker object; anything stored under that prefix stays where it is and reappears on refresh.
